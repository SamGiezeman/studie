...
ProjectPath            :=C:/ti-software/v1oopc-practica/week1
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/blackBox.cpp$(ObjectSuffix): blackBox.cpp $(IntermediateDirectory)/blackBox.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/blackBox.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/blackBox.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/blackBox.cpp$(DependSuffix): blackBox.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/blackBox.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/blackBox.cpp$(DependSuffix) -MM blackBox.cpp

$(IntermediateDirectory)/blackBox.cpp$(PreprocessSuffix): blackBox.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/blackBox.cpp$(PreprocessSuffix) blackBox.cpp

$(IntermediateDirectory)/circle.cpp$(ObjectSuffix): circle.cpp $(IntermediateDirectory)/circle.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/circle.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/circle.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/line.cpp$(ObjectSuffix): line.cpp $(IntermediateDirectory)/line.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/line.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/line.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/rectangle.cpp$(ObjectSuffix): rectangle.cpp $(IntermediateDirectory)/rectangle.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/rectangle.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/rectangle.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/steamship.cpp$(ObjectSuffix): steamship.cpp $(IntermediateDirectory)/steamship.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/steamship.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/steamship.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/steamship.cpp$(DependSuffix): steamship.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/steamship.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/steamship.cpp$(DependSuffix) -MM steamship.cpp

$(IntermediateDirectory)/steamship.cpp$(PreprocessSuffix): steamship.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/steamship.cpp$(PreprocessSuffix) steamship.cpp

$(IntermediateDirectory)/window.cpp$(ObjectSuffix): window.cpp $(IntermediateDirectory)/window.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-practica/week1/window.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/window.cpp$(ObjectSuffix) $(IncludePath)
